...
#define OBJECT_TYPE_MUSHROOM_LEAF 6
...
#define ID_SPRITE_MARIO_RACCOON_FLY_UP_RIGHT (ID_SPRITE_MARIO_RACCOON_FLY + 1)
#define ID_SPRITE_MARIO_RACCOON_FLY_UP_LEFT (ID_SPRITE_MARIO_RACCOON_FLY + 100)
#define ID_SPRITE_MARIO_RACCOON_FLY_DOWN_RIGHT (ID_SPRITE_MARIO_RACCOON_FLY + 200)
#define ID_SPRITE_MARIO_RACCOON_FLY_DOWN_LEFT (ID_SPRITE_MARIO_RACCOON_FLY + 300)
