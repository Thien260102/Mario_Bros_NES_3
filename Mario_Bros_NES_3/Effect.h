...
protected:
	...
	ULONGLONG renderTime_start;
	int idSpriteorAni;
	bool isSprite; // true: effect is sprite, false: effect is animation

public:
	CEffect() { renderTime_start = 0; vy = 0; effects.clear(); idSpriteorAni = 0; isSprite = true; }
